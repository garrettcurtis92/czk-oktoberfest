...
{/* Add Points Card */}
<div className="rounded-2xl bg-white/80 backdrop-blur shadow p-4 space-y-3">
  <form action={addScoreAction} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
    ...
    <div className="sm:col-span-1 min-w-0">
      ...
      <Select value={eventId} onValueChange={setEventId}>
        <SelectTrigger
          className="mt-1 w-full max-w-full sm:max-w-[320px] rounded-xl border border-gray-300 bg-white/90 px-3 py-2 shadow-sm overflow-hidden"
        >
          {/* Wrap value in a truncation span */}
    ...
    <div className="sm:col-span-1 min-w-0">
      ...
      <Select value={teamId} onValueChange={setTeamId}>
        <SelectTrigger className="mt-1 w-full sm:max-w-[240px] rounded-xl border border-gray-300 bg-white/90 px-3 py-2 shadow-sm">
    ...
    <div className="sm:col-span-2">
      ...
      <div className="rounded-2xl bg-white/80 backdrop-blur shadow p-4">
              <h2 className="text-lg font-display mb-2">Recent Scores</h2>
              {recent.length === 0 ? (
                  ...
                  <ul className="space-y-2">
                      {recent.map((s) => {
                          ...
                          return (
                              <li key={s.id} className="flex items-center justify-between gap-3 rounded-xl bg-white/70 p-3">
                                  ...
                                  <form action={deleteScoreAction}>
                                      ...
                                      <Button type="submit" variant="outline" className="rounded-xl">Undo</Button>
                                  </form>
                              </li>
                          );
                      })}
